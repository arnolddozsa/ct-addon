...
use DI\Model\Entity\Administration\Definitions\Finance\Pay_Mode;
use UI\Html\Button;


/**
 * Érme értékesítések report.
 */
class CoinSales extends \UI\View\Pub\Pages\Page{
	...
	public function CreateContent(){
		...
		$printPageParams = array("namespace" => "CityMedia\\CoinSales\\");
		...
		<h1 class="center-text"><?php echo Translate::Get("coin_sales"); ?></h1>
			...
			<div class="row justify-content-center">
				<div class="col-4">
					<form id="form">
						...
						<label for="<?php echo (new \ReflectionClass($this))->getShortName(); ?>_dateTo"><?php echo Translate::Get("date_from");?></label>
						<div class="input-group">
							<?php
