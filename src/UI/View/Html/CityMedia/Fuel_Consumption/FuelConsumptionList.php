...
/**
 * Üzemanyag felhasználás lista nézet osztály.
 */
class FuelConsumptionList implements \UI\View\IView{
	...
	public function CreateContent(){
            ...
            $(function () {
                ...
                $(`${window.elementID}_datatable_list`).on("pageLoad", function(){
                    ...
                    $(this).find("tbody tr td:last-child() a").each(function(){
                        $(this).prop("href", `/CityMedia/Fuel_Consumption/Fuel_Consumption/?id=${($(this).find("button").val())}`);
                ...
                $(`${window.elementID}_addNew_button`).on("click", function () {
                    window.location = window.location.origin + "/CityMedia/Fuel_Consumption/Fuel_Consumption/";
                });
		...
		<h1 class="center-text"><?php echo Trans::Get("list_of_fuel_consumptions"); ?></h1>
